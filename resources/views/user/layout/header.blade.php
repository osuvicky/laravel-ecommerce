			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					@if (Route::has('login'))
						...
						<a href="{{url('show_order')}}" class="flex-c-m trans-04 p-lr-25">
							My Orders
						</a>
						<form method="POST" action="{{ route('logout') }}" class="flex-c-m trans-04 p-lr-25">
                                @csrf
						<button class="flex-c-m trans-04 p-lr-25" style="color:white">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="{{url('show_cart')}}" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="{{$total}}">
